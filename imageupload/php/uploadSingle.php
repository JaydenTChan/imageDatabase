...
<html>
	...
	for($i=0; $i<count($_FILES['image']['name']); $i++) {
        ...
        if(getimagesize($_FILES['image']['tmp_name'][$i]) == FALSE){
    		...
    		//used to save blob
    		$sql = 'insert into images (photo_id,owner_name,permitted,subject,place,timing,description,thumbnail,photo) values 
    (:photo_id, :owner_name, :permitted, :subject, :place, TO_DATE( :time, \'DD-MM-YYYY\'), :notes, EMPTY_BLOB(), EMPTY_BLOB()) returning thumbnail, photo into :thumbnail, :photo';
